...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char *argv[])
{
    ...
    *appstate = as;
    ...
    auto assetsDir = projectRoot / "assets";
    auto scenesDir = projectRoot / "scenes";
    auto scriptsDir = projectRoot / "scripts";
    auto projectFile = projectRoot / "game.project";

    std::cout << "Assets: " << assetsDir << std::endl;
    std::cout << "Scenes: " << scenesDir << std::endl;
    std::cout << "Scripts: " << scriptsDir << std::endl;
