...
{
	Core::ModelAssetId    id;
	std::filesystem::path path;
	Core::ImportedModel   imported;
};

class AssetRegistry
{
	Core::ModelAssetId                                            nextModelId = 1;
	std::unordered_map<std::filesystem::path, Core::ModelAssetId> pathToModel;
	std::unordered_map<Core::ModelAssetId, ModelAssetRecord>      models;
};

Runtime     *Runtime::runtime_     = nullptr;
Coordinator *Runtime::gCoordinator = nullptr;
...
Runtime *Runtime::GetInstance()
{
	...
	runtime_->createMesh(cubeDescriptor);
...
Coordinator *Runtime::GetCoordinator()
{
